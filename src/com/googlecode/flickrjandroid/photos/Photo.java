...
public class Photo implements Serializable {
	...
	/**
	 * Sets the number of views for this Photo. For un-authenticated calls this
	 * value is not available and will be set to -1.
	 * 
	 * @param views
	 */
	...
	/**
	 * Get an InputStream for the original image. Callers must close the stream
	 * upon completion.
	 * 
	 * @deprecated
	...
	/**
	 * Get an image as a stream. Callers must be sure to close the stream when
	 ...
	 */
	private InputStream getOriginalImageAsStream(String suffix)
